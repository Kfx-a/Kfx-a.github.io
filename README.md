# StreamTube - Minimalist Video Player

A clean, minimalist video player built with React, TypeScript, and Tailwind CSS, featuring a YouTube-style grid and Odysee video integration.
...
- `src/constants.ts`: Mock data and video configurations.
